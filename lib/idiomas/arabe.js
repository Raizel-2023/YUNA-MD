...
const smsSetB2 = () => { return `${lenguajeGB['smsAvisoIIG']()}🙌 *اكتب رسالة الوداع\nاختياري يمكنك استخدام ما هو مع"@" لإضافة المزيد من المعلومات:\n\n @user(أذكر للمستخدم) \nتذكر أن ملف"@" اختياري *`}

//grupo-setwelcome.js
const smsSetW = () => { return `${lenguajeGB['smsAvisoEG']()}*تم إعداد ترحيب المجموعة*`}
const smsSetW2 = () => { return `${lenguajeGB['smsAvisoIIG']()}🙌 *اكتب رسالة الوداع\nاختياري يمكنك استخدام ما هو مع"@" لإضافة المزيد من المعلومات:\n\n @user(أذكر للمستخدم) \nتذكر أن ملف"@" اختياري*`}

//grupo-setdesc.js
const smsDest = () => { return `${lenguajeGB['smsAvisoEG']()}*تم تكوين وصف المجموعة*`}

//grupo-setname.js
const smsNam1 = () => { return `${lenguajeGB['smsAvisoEG']()}*تم تكوين اسم المجموعة*`}
const smsNam2 = () => { return `${lenguajeGB['smsAvisoMG']()}*🙌 أدخل اسم المجموعة الجديد*`}
const smsNam3 = () => { return `${lenguajeGB['smsAvisoFG']()}*يجب ألا يزيد اسم المجموعة عن 25 حرفا*`}

//grupo-restaurarEnlace.js
const smsRestGp = () => { return `${lenguajeGB['smsAvisoEG']()}*تم إعادة إنشاء رابط المجموعة*`}
