...
if (!args || !args[0]) return conn.reply(m.chat, `${lenguajeGB['smsAvisoMG']()} أدخل رابط YOUTUBE لتنزيل المستند الصوتي \ مثال  \n*${usedPrefix + command} https://youtu.be/85xI8WFMIUY*\n`, fkontak,  m)
...
handler.command = /^playaudiodoc|pdocaudio|docaudio|ytmp3doc|ytadoc|صوت|yta.2$/i
handler.limit = 3
